...
import '../../domain/core/sharedPref.model.dart' as _i12;
import '../../domain/dashboard/dashboard.facade.dart' as _i7;
import '../../infrastructure/auth/auth.repo.dart' as _i4;
import '../../infrastructure/core/injectable.module.dart' as _i13;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.factoryAsync<_i11.SharedPreferences>(
      ...
      preResolve: true);
  gh.factory<_i12.SharedPref>(
      () => _i12.SharedPref(get<_i11.SharedPreferences>()));
  return get;
}

class _$FormKeyModule extends _i13.FormKeyModule {}
