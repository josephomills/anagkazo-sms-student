...
import '../../domain/core/sharedPref.model.dart' as _i17;
...
import '../../infrastructure/core/injectable.module.dart' as _i18;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.factoryAsync<_i15.SharedPreferences>(
      ...
      preResolve: true);
  gh.factory<_i16.MyFellowshipBloc>(
      () => _i16.MyFellowshipBloc(get<_i13.MyFellowshipFacade>()));
  gh.factory<_i17.SharedPref>(
      () => _i17.SharedPref(get<_i15.SharedPreferences>()));
  return get;
}

class _$FormKeyModule extends _i18.FormKeyModule {}
