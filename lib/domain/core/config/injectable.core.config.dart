...
import 'package:student/application/attendance/attendance/attendance_bloc.dart'
    as _i19;
import 'package:student/application/attendance/scan/scan_bloc.dart' as _i21;
...
import 'package:student/domain/core/config/injectable_modules.dart' as _i22;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i19.AttendanceBloc>(
        () => _i19.AttendanceBloc(gh<_i3.AttendanceFacade>()));
    gh.lazySingleton<_i20.MyFellowshipBloc>(
        () => _i20.MyFellowshipBloc(gh<_i15.MyFellowshipFacade>()));
    gh.lazySingleton<_i21.ScanBloc>(() => _i21.ScanBloc(gh<_i17.ScanFacade>()));
    return this;
  }
}
