...
import 'package:student/application/auth/auth/auth_bloc.dart' as _i20;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i20.AuthBloc>(_i20.AuthBloc(gh<_i5.AuthFacade>()));
    gh.lazySingleton<_i21.MyFellowshipBloc>(
        () => _i21.MyFellowshipBloc(gh<_i15.MyFellowshipFacade>()));
    gh.lazySingleton<_i22.ScanBloc>(() => _i22.ScanBloc(gh<_i17.ScanFacade>()));
    return this;
  }
}

class _$FormModule extends _i23.FormModule {}
