...
import 'package:student/presentation/pages/academics/academics.page.dart'
    as _i8;
import 'package:student/presentation/pages/academics/rotation.page.dart' as _i9;
...
import 'package:student/presentation/pages/attendance/tabs/other.tab.dart'
    as _i2;
import 'package:student/presentation/pages/auth/login.page.dart' as _i15;
...
import 'package:student/presentation/pages/documents/documents.page.dart'
    as _i18;
import 'package:student/presentation/pages/forms/forms.page.dart' as _i13;
import 'package:student/presentation/pages/home/home.page.dart' as _i11;
import 'package:student/presentation/pages/index.page.dart' as _i20;
...
import 'package:student/presentation/pages/pastoral_points/pastoral_points.page.dart'
    as _i19;
import 'package:student/presentation/pages/profile/profile.page.dart' as _i17;
import 'package:student/presentation/pages/settings/settings.page.dart' as _i10;
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ChurchTabRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i1.ChurchTabPage(),
      );
    },
    OtherTabRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i2.OtherTabPage(),
      );
    },
    LectureTabRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i3.LectureTabPage(),
      );
    },
    ...
    AttendanceRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i23.WrappedRoute(child: const _i5.AttendancePage()),
      );
    },
    RotationsTabRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i6.RotationsTabPage(),
      );
    },
    OtherPointsTabRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i7.OtherPointsTabPage(),
      );
    },
    AcademicsRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.AcademicsPage(),
      );
    },
    ...
    MyFellowshipRoute.name: (routeData) {
      ...
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i23.WrappedRoute(child: _i12.MyFellowshipPage(key: args.key)),
      );
    },
    FormsRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i13.FormsPage(),
      );
    },
    ...
    LoginRoute.name: (routeData) {
      ...
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i23.WrappedRoute(child: _i15.LoginPage(key: args.key)),
      );
    },
    ...
    ProfileRoute.name: (routeData) {
      ...
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i23.WrappedRoute(child: _i17.ProfilePage(key: args.key)),
      );
    },
    DocumentsRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i18.DocumentsPage(),
      );
    },
    PastoralPointsRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i19.PastoralPointsPage(),
      );
    },
    IndexRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i20.IndexPage(),
      );
    },
    DisciplineRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i21.DisciplinePage(),
      );
    },
    AccommodationRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i22.AccommodationPage(),
      );
    },
  };
}
